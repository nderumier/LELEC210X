...
for strategy, num_bands in configurations:
    ...
    # --- NEW STEP 5.3: Print Standalone Test Metrics for this Model ---
...
# Get the hard predictions for every single model (Shape: Num_Models x Num_Samples)
individual_predictions = np.argmax(all_probs_3d, axis=2)
num_models, num_samples = individual_predictions.shape

# Check if all models voted exactly the same way for a given sample
